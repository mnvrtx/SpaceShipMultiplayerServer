...
public class SocSrvHandler extends BaseHndlrToClntInSvcToSvc<SocSrvConfig, TokenFromClientReader, ConnectorToRelayService> {
    ...
    private void connectToRelayService(ChannelHandlerContext ctx, Object msg) throws InvalidPropertiesFormatException {
        connectorToService.connectServiceToService(new BaseConnectorInSvcToSvc.ConnectToServiceCallback() {
            ...
            public void success(ChannelFuture channelFuture, BaseHandlerInSvcToSvc svcToSvcHandler) {
                tokenFromClientReader.setSrvToSrvHandler((SocToRelayHandler) svcToSvcHandler);
