...
public abstract class BaseTcpHndlrToClntInSvcToSvc<T extends BaseConfigModel, S extends BaseReaderTrnCSS, U extends BaseConnectorInSvcToSvc> extends BaseTcpChannelInboundHandlerAdapter<T> {
